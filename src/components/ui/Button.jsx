...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-global-13 text-sidebar-1 hover:bg-opacity-90 disabled:bg-global-2',
    secondary: 'bg-global-4 text-global-3 hover:bg-global-5 disabled:bg-global-5',
    outline: 'border border-global-2 text-global-2 hover:bg-global-4 disabled:border-global-2 disabled:text-global-4',
  };
